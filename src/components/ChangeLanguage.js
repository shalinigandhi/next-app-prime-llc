...
export default function ChangeLanguage() {
  ...
  const buttonClasses =
    "px-4 py-2 text-white flex items-center border border-solid rounded-[39px] border-[#94949480] focus:outline-none cursor-pointer text-[12px] lg:text-[14px]";
  const imgClasses = "w-[24px] h-[24px] mr-[10px]";
  const dropdownClasses =
    "absolute mt-2 right-0 w-32 bg-black text-white font-medium text-[14px] rounded-[14px] border border-solid border-[#94949480] z-[1] cursor-pointer";
